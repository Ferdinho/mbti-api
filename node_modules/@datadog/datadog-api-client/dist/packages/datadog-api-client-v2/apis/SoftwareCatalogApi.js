...
class SoftwareCatalogApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    listCatalogEntity(pageOffset, pageLimit, fitlerId, fitlerRef, fitlerName, fitlerKind, fitlerOwner, fitlerRelationType, fitlerExcludeSnapshot, include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            ...
            if (fitlerId !== undefined) {
                requestContext.setQueryParam("fitler[id]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerId, "string", ""));
            }
            if (fitlerRef !== undefined) {
                requestContext.setQueryParam("fitler[ref]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerRef, "string", ""));
            }
            if (fitlerName !== undefined) {
                requestContext.setQueryParam("fitler[name]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerName, "string", ""));
            }
            if (fitlerKind !== undefined) {
                requestContext.setQueryParam("fitler[kind]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerKind, "string", ""));
            }
            if (fitlerOwner !== undefined) {
                requestContext.setQueryParam("fitler[owner]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerOwner, "string", ""));
            }
            if (fitlerRelationType !== undefined) {
                requestContext.setQueryParam("fitler[relation][type]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerRelationType, "RelationType", ""));
            }
            if (fitlerExcludeSnapshot !== undefined) {
                requestContext.setQueryParam("fitler[exclude_snapshot]", ObjectSerializer_1.ObjectSerializer.serialize(fitlerExcludeSnapshot, "string", ""));
            }
...
class SoftwareCatalogApi {
    ...
    listCatalogEntity(param = {}, options) {
        const requestContextPromise = this.requestFactory.listCatalogEntity(param.pageOffset, param.pageLimit, param.fitlerId, param.fitlerRef, param.fitlerName, param.fitlerKind, param.fitlerOwner, param.fitlerRelationType, param.fitlerExcludeSnapshot, param.include, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
    ...
    listCatalogEntityWithPagination(param = {}, options) {
        return __asyncGenerator(this, arguments, function* listCatalogEntityWithPagination_1() {
            ...
            param.pageOffset = 0;
            while (true) {
                const requestContext = yield __await(this.requestFactory.listCatalogEntity(param.pageOffset, param.pageLimit, param.fitlerId, param.fitlerRef, param.fitlerName, param.fitlerKind, param.fitlerOwner, param.fitlerRelationType, param.fitlerExcludeSnapshot, param.include, options));
