...
export declare class SoftwareCatalogApiRequestFactory extends BaseAPIRequestFactory {
    ...
    listCatalogEntity(pageOffset?: number, pageLimit?: number, fitlerId?: string, fitlerRef?: string, fitlerName?: string, fitlerKind?: string, fitlerOwner?: string, fitlerRelationType?: RelationType, fitlerExcludeSnapshot?: string, include?: IncludeType, _options?: Configuration): Promise<RequestContext>;
