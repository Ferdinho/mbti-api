...
export declare class CloudCostManagementApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listAWSRelatedAccounts(response: ResponseContext): Promise<AWSRelatedAccountsResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class CloudCostManagementApi {
     ...
     * @param param The request object
     */
    listAWSRelatedAccounts(param: CloudCostManagementApiListAWSRelatedAccountsRequest, options?: Configuration): Promise<AWSRelatedAccountsResponse>;
    /**
